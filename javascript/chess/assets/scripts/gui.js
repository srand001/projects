...
function ClickedSquare(pageX, pageY) {
  ...
  position.top = position.top + 25;    // Fix for wrong square selected - vertical.  Surj - 11Jun2026
  position.left = position.left + 20;  // Fix for wrong square selected - horizontal. Surj
...
function PreSearch() {
		...
		if(GameController.GameOver != BOOL.TRUE) {				
			...
			$('#ThinkingImageDiv').append('<image src="assets/images/think3.png" id="ThinkingPng"/>')
...
function AddGUIPiece(sq,pce) {	
	...
	pieceFileName = "assets/images/" + SideChar[PieceCol[pce]] + PceChar[pce].toUpperCase() + ".png";
