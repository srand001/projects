...
async function weatherCheck(city){
  ...
  switch(weather_data.weather[0].main){
    ...
    case 'Rain':
        weather_current = "rain.gif";
        break;

    case 'Clouds':
        weather_current = "cloudy.gif";
        break;

    case 'Mist':
        weather_current= "mist.gif";
        break;

    case 'Snow':
        weather_current = "snow.gif";
        break;

    case 'Clear':
        weather_current = "clear.gif";
        break; 
  ...
  // Updated - Surj 16Jun2026
  weather_status.src = "images" + "/" + weather_current;
}
