  ...
  <div class="sign-popup-wrapper brd-rd5">
    <div class="sign-popup-inner brd-rd5">
      ...
      <div class="sign-popup-title text-center">
        <h4 itemprop="headline">User Login</h4> <!-- Was 'SIGN IN' - Surj 25May2026 -->
        <b>
          <p style="color: black;">For demo purposes, a customer user name and password are already filled in.
            Please press "Login".</p>
      </div>
      ...
      <form class="sign-form" method="post">
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-lg-12">
            <button class="red-bg brd-rd3" type="submit" name="login">Login</button>
          </div>
          <div class="col-md-12 col-sm-12 col-lg-12">
