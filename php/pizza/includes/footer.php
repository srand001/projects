            ...
            <div class="row">
              <div class="col-md-3 col-sm-6 col-lg-3">
                <div class="widget about_widget wow fadeIn" data-wow-delay="0.1s">
                  <!-- Main_Title_Text -->
                  <div class="logo">
                    <h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url" style="color:#fff">Italian
                        Cuisine</a></h1>
                  </div>
                </div>
              </div>
              ...
              <!-- Admin login fixed - Surj 25May2026 ----->
              <div class="col-md-3 col-sm-6 col-lg-3">
                <div class="widget information_links wow fadeIn" data-wow-delay="0.2s">
                  <h4 class="widget-title" itemprop="admin">Admin</h4>
                  <ul>
...
<div class="bottom-bar dark-bg text-center">
  <div class="container">
    <!-- Main_Title_Text -->
    <p itemprop="description">Italian Cuisine</p>
  </div>
</div><!-- Bottom Bar -->