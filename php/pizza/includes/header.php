...
<main>
  ...
  <header class="stick">
      ...
      <div class="container">
        ...
        <div class="topbar-register">
          ...
          <?php if (strlen($_SESSION['fosuid'] == 0)) { ?>
            <a class="log-popup-btn" href="#" title="Login" itemprop="url">LOGIN</a> / <a class="sign-popup-btn" href="#"
        ...
        <div class="social1">
          <span style="color:#fff;"><i>Italian Cuisine by Luigi</i></span> <!-- Main_Title_Text -->
        </div>
      </div>
    </div><!-- Topbar -->
    <div class="logo-menu-sec">
      <div class="container">
        <!-- Main_Title_Text -->
        <div class="logo">
          <h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url">Luigi</a></h1>
        </div>
        <nav>
          <div class="menu-sec">
            <ul>
              ...
              <li class="menu-item-has-children"><a href="our-menu.php" title="RESTAURANTS" itemprop="url">Our
                  Menu</a>
                <ul class="sub-dropdown">
                  ...
                  while ($row = mysqli_fetch_array($query)) {
                    ?>
                    <li><a href="categorywise-menu.php?catid=<?php echo $row['CategoryName']; ?>"
                        title="<?php echo $row['CategoryName']; ?>" itemprop="url"><?php echo $row['CategoryName']; ?></a>
                    </li>
                  <?php } ?>
                </ul>
              </li>
              ...
              <li><a href="admin/" title="Admin" itemprop="url">Admin</a></li> <!-- Admin added Surj 25May2026 -->
  ...
  <div class="responsive-header">
    ...
    <div class="responsive-logomenu">
      <div class="logo">
        <h1 itemprop="headline"><a href="index-2.html" title="Home" itemprop="url">Food Ordering System</h1>
      </div>
