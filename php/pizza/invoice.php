  ...
  <div style="margin-left:50px;">
    ...
    <table border="1" cellpadding="10"
      ...
      while ($row = mysqli_fetch_array($query)) {
        ...
        <tr>
          <td><?php echo $cnt; ?></td>
          <td><img src="admin/itemimages/<?php echo $row['Image'] ?>" width="60" height="40"
    ...
    <p>
      <input name="Submit2" type="submit" class="txtbox4" value="Close" onClick="return f2();"
        style="cursor: pointer;" /> <input name="Submit2" type="submit" class="txtbox4" value="Print"
