...
<head>
  ...
  <title>Italian Cuisine</title> <!-- Main_Title_Text -->
...
<body itemscope>
  ...
  <section>
    <div class="block blackish opac50">
      <div class="fixed-bg" style="background-image: url(assets/images/main-parallax2.jpg);"></div>
      <div class="restaurant-searching style2 text-center">
        <div class="restaurant-searching-inner">
          <h2 itemprop="headline">Order Delivery and Take Away</h2>
            ...
            <div class="sec-box">
              <div class="remove-ext">
                <div class="row">
                  ...
                  // Note: This information will appear on the screen after website loaded
                    ...
                    <div class="col-md-4 col-sm-6 col-lg-4">
                      <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                        <div class="popular-dish-thumb">
                          <a href="food-detail.php?fid=<?php echo $row['ID']; ?>" title="" itemprop="url"><img
                              src="admin/itemimages/<?php echo $row['Image']; ?>" alt="<?php echo $row['ItemName']; ?>"
                              itemprop="image" width="450" height="280"></a> <!-- Food Thumbnail Images -->
                        </div>
                        <div class="popular-dish-info">
                          <h4 itemprop="headline"><a href="food-detail.php?fid=<?php echo $row['ID']; ?>" title=""
                              itemprop="url"><?php echo $row['ItemName']; ?></a></h4>
                          <form method="post">
                            <p itemprop="description">
                              <input type="hidden" name="foodid" value="<?php echo $row['ID']; ?>">
                              <input class="qty" name="foodqty" type="text" value="1">
                            </p>
                            <span class="price"><?php echo $currency, $row['ItemPrice']; ?></span>
...
<ul class="pagination"> -->
                  ...
                  <?php if ($page_no < $total_no_of_pages) { ?>
                    <li class="page-item next"><a class="page-link brd-rd2"
                        href='?page_no=<?php echo $total_no_of_pages; ?>'>Last &rsaquo;&rsaquo;</a></li>
                    <?php
                  } ?>
