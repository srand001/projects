...
<body>
          ...
          <div class="col-lg-4">
            <div class="ibox ">
              <div class="ibox-title">
                ...
                ?>
                <a class="text-muted text-uppercase m-b-20" href="all-order.php" style="font-size: 20px"><strong>Total
                    Order</strong></a>
                <h5></h5>
              </div>
            ...
            <div class="ibox ">
              <div class="ibox-title">
                ...
                <a class="text-muted text-uppercase m-b-20" href="notconfirmedyet.php"
                  style="font-size: 20px"><strong>New Order</strong></a>
            ...
            <div class="ibox ">
              <div class="ibox-title">
                ...
                <a class="text-muted text-uppercase m-b-20" href="confirmed-order.php"
                  style="font-size: 20px"><strong>Confirmed Order</strong></a>
          ...
          <div class="col-lg-4">
            <div class="ibox ">
              <div class="ibox-title">
                ...
                ?>
                <a class="text-muted text-uppercase m-b-20" href="food-pickup.php" style="font-size: 20px"><strong> Food
                    Pickup</strong></a>
            ...
            <div class="ibox ">
              <div class="ibox-title">
                ...
                <a class="text-muted text-uppercase m-b-20" href="food-delivered.php"
                  style="font-size: 20px"><strong>Total Food Deliver</strong></a>
            ...
            <div class="ibox ">
              <div class="ibox-title">
                ...
                <a class="text-muted text-uppercase m-b-20" href="canclled-order.php"
                  style="font-size: 20px"><strong>Cancelled Order</strong></a>
          ...
          <div class="col-lg-4">
            <div class="ibox ">
              <div class="ibox-title">
                ...
                ?>
                <a class="text-muted text-uppercase m-b-20" href="user-detail.php" style="font-size: 20px"><strong>Total
                    Regd. User</strong></a>
  ...
  <script>
    $(document).ready(functio n() {
      $('.chart').easyPieChart({
        barColor: '#f8ac59', //                scaleColor: false,         scaleLength: 5,         lineWidth: 4,         size: 80       });
        $('.chart2').easyPieChart({
          barColor: '#1c84c6', //                scaleColor: false,         scaleLength: 5,         lineWidth: 4,         size: 80       });
          var data2 = [
            [gd(2012, 1, 1), 7],
            [gd(2012, 1, 2), 6],
            [gd(2012, 1, 3), 4],
