...
if (strlen($_SESSION['fosaid'] == 0)) {
  ...
  if (isset($_GET['delfood'])) {
    ...
    if ($query) {
      ...
      echo "<script>window.location.href='add-fooditem.php'</script>";
    }
  }
                    ...
                    while ($row = mysqli_fetch_array($ret)) {
                      ...
                      <tbody>
                        <tr>
                          ...
                          <!-- Bug fix for wrong url like - manage-fooditems.phpp?delfood - Surj Jul2026 -->
                          <td>
                            <a href="editfooditem.php?editid=<?php echo $row['ID']; ?>" class="btn btn-primary">Edit</a>
                            <a href="manage-fooditems.php?delfood=<?php echo $row['ID']; ?>"
                              onclick="return confirm('Do you really want to delete the food item?');"
