...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    // Note: This information will appear on the screen after selecting a category
    ...
    ?>
                                        ...
                                        <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                                            <div class="popular-dish-thumb">
                                                <a href="food-detail.php?fid=<?php echo $row['ID'];?>" title="" itemprop="url"><img src="admin/itemimages/<?php echo $row['Image'];?>" alt="<?php echo $row['ItemName'];?>" itemprop="image" width="450" height="280"></a>   <!-- Food Thumbnail Images -->
                                            </div>
